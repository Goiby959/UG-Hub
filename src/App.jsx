...
const AUTO_BADGE_RULES = {
  ...
  // Only populated once the donations table + Stripe webhook are wired
  // up — until then this simply never matches anyone.
  donations: { table: "donations", filterCol: "user_id", select: "amount", reduce: (rows) => rows.reduce((s, r) => s + (Number(r.amount) || 0), 0) },
};
...
const THRESHOLD_KIND_LABELS = {
  ...
  donations: "DOLLARS DONATED (TOTAL)",
};
    ...
    <div>
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        >
          ...
          <option value="donations">Automatic — donates $X total</option>

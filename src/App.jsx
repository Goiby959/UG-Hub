  ...
  return (
    <style>{`
      ...
      * { box-sizing: border-box; }
      ...
      .ughub-art-card.boost-4 { position: relative; padding: 2px; background: linear-gradient(270deg, #5bafd4, #a78bfa, #5bafd4, #38bdf8) !important; background-size: 300% 300% !important; animation: ughub-boost-gradient 3s ease infinite; border: none !important; }
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 28, flexWrap: "wrap" }}>
        ...
        <div style={{ position: "relative" }}>
          <button
            onClick={() => { if (canBoost && !isBannedUser) setBoostPopoverOpen((o) => !o); }}
          ...
          {boostPopoverOpen && (
            ...
            >
              <p style={{ margin: "0 0 10px", fontSize: "0.82rem", color: tokens.cream, fontWeight: 700 }}>
                Boost this piece
              </p>
              {!isUnlimitedBoosts && (
                <p style={{ margin: "0 0 10px", fontSize: "0.74rem", color: "rgba(217,200,168,0.5)" }}>
                  {boostsRemaining} boost{boostsRemaining !== 1 ? "s" : ""} remaining this week
                </p>
              )}
              <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 12 }}>
                <label style={{ fontSize: "0.76rem", color: "rgba(217,200,168,0.55)", flexShrink: 0 }}>Quantity</label>
                <input
                  type="number"
                  min="1"
                  ...
                  style={{ ...selectStyle, width: 64, padding: "6px 8px" }}
                />
              </div>
              <div style={{ display: "flex", gap: 8 }}>
                <button
                  onClick={() => setBoostPopoverOpen(false)}
                  style={{ ...buttonStyles.ghostSmall, flex: 1, fontSize: "0.78rem", padding: "7px 0" }}
                >
                  Cancel
                </button>
                <button
                  ...
                  style={{ ...buttonStyles.primarySmall, flex: 1, fontSize: "0.78rem", padding: "7px 0" }}
                >
                  Confirm ↑
                </button>
              </div>

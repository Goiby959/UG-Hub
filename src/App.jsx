  ...
  useEffect(() => {
    (async () => {
      const [postsRes, likesRes, boostsRes, followsRes, myLikesRes] = await Promise.all([
        ...
        dbSelect("fan_art_boosts", "select=art_id,expires_at"),
  ...
  useEffect(() => {
    (async () => {
      const [postRes, likeRes, allLikesRes, commentRes, boostRes, allBoostsRes, balanceRes] = await Promise.all([
        ...
        dbSelect("fan_art_boosts", "art_id=eq." + postId + "&select=id,user_id,created_at,expires_at,profiles(username)&order=created_at.desc"),
    ...
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          {isOwner && (
            <button onClick={() => onBack({ edit: postId })} style={{ ...buttonStyles.ghostSmall, display: "flex", alignItems: "center", gap: 6 }}>
              <Icon.Edit /> Edit
            </button>
          )}
          {canDelete && (
        ...
        >
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button
              ...
              style={{ ...buttonStyles.ghostSmall, flex: 1 }}
            >
              Cancel
            </button>
            <button
              ...
              style={{ ...buttonStyles.primarySmall, flex: 1 }}
            >
              Confirm ↑
            </button>
          </div>
      ...
      {isUnlimitedBoosts && boostsList.length > 0 && (
        <div style={{ marginBottom: 20 }}>
          <p style={{ fontFamily: "'Bebas Neue'", color: "rgba(91,175,212,0.7)", fontSize: "0.82rem", letterSpacing: "0.14em", textTransform: "uppercase", margin: "0 0 8px" }}>
...
function ArtistProfile({ userId, username, currentUser, onNavigate, onBack, showToast }) {
  ...
  return (
    <div>
      <button onClick={onBack} style={{ ...buttonStyles.ghostSmall, marginBottom: 20 }}>← Fan Art</button>
      ...
      <div style={{ display: "flex", gap: 16, alignItems: "flex-start", marginBottom: 16 }}>
        ...
        <div style={{ minWidth: 0, flex: 1 }}>
          <h1 style={{ fontFamily: "'Rubik'", fontWeight: 900, fontSize: "1.5rem", color: tokens.cream, margin: 0, overflowWrap: "anywhere" }}>
  ...
  if (justSucceeded) {
    return (
      <div style={{ textAlign: "center", padding: "60px 20px" }}>
        ...
        <h1 style={{ fontFamily: "'Rubik'", fontWeight: 900, fontSize: "1.6rem", color: tokens.cream, marginBottom: 8 }}>
          Thank you so much!
        </h1>
        ...
        <button onClick={onBack} style={{ ...buttonStyles.primarySmall, padding: "10px 28px" }}>
          Back to UG Hub
        </button>
      </div>
    );
  ...
  return (
    <div>
      ...
      <div style={{ textAlign: "center", marginBottom: 28 }}>
        ...
        <h1 style={{ fontFamily: "'Rubik'", fontWeight: 900, fontSize: "1.8rem", color: tokens.cream, margin: "0 0 8px" }}>
          Buy me a coffee
        </h1>
      ...
      <div style={{ maxWidth: 280, margin: "0 auto 8px" }}>
        ...
        <div style={{ position: "relative" }}>
          ...
          <input
            ...
            value={amount}
            onChange={(e) => setAmount(e.target.value)}
            style={{ ...inputStyle, width: "100%", paddingLeft: 28, textAlign: "center", fontSize: "1.2rem", fontWeight: 700 }}
          />
        </div>
      ...
      <div style={{ maxWidth: 280, margin: "20px auto 0" }}>
        <button
          ...
          disabled={submitting}
          style={{ ...buttonStyles.primarySmall, width: "100%", padding: "12px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}
        >

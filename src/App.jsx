  ...
  return (
    <style>{`
      ...
      * { box-sizing: border-box; }
      ...
      .ughub-art-card.boost-1 { border: 2px solid #5bafd4; }

      /* Boost tier 2 (3-5 boosts): thicker glowing blue */
      .ughub-art-card.boost-2 { border: 2px solid #5bafd4; box-shadow: 0 0 10px rgba(91,175,212,0.55), 0 0 20px rgba(91,175,212,0.25); }

      /* Boost tier 3 (6-9 boosts): pulsing blue */
      .ughub-art-card.boost-3 { border: 2px solid #5bafd4; box-shadow: 0 0 12px rgba(91,175,212,0.7), 0 0 28px rgba(91,175,212,0.35); animation: ughub-boost-pulse 2s ease-in-out infinite; }

      /* Boost tier 4 (10+ boosts): animated gradient border */
      .ughub-art-card.boost-4 { border: 2px solid transparent; position: relative; }
